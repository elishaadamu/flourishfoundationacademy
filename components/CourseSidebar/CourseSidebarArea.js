...
const CourseSidebarArea = () => {
  // We continue to fetch all activities even though we override the category list below.
  ...
  // Instead of using dynamic categories from data, use a static array of school activity topics.
  ...
  // categoryFilter flag for pagination
  ...
  // Use the fetched data (or fallback to an empty array) and paginate if no category filter is set.
  ...
  // Handle category filter changes. If "All Categories" is selected, clear filter.
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                    <div className="course__view text-end">
                      <h4>{`Showing 1 - ${courseItems?.length} of ${allCourseItems?.length} Activities`}</h4>
                    </div>
                  </div>
                </div>
              </div>
                                      ...
                                      <div className="course__right p-relative">
                                        <div className="course__content p-relative">
                                          ...
                                          <div className="course__summary">
                                            <p>
                                              Join us for a dynamic school
                                              activity where we conduct events
                                              such as Swachh Bharat Drives,
                                              Olympiads, Cultural Programs,
                                              Environment Initiatives, and Space
                                              Exploration Clubs.
                                            </p>
                                          </div>
              ...
              <div className="course__sidebar pl-70">
                ...
                <div className="course__sidebar-widget white-bg">
                  <div className="course__sidebar-info">
                    <h3 className="course__sidebar-title">
                      Activity Categories
                    </h3>
                    <ul>
