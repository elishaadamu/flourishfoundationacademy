...
const TeamDetailsArea = ({ singleTeam }) => {
  ...
  if (!isLoading && !isError && courses.length > 0) {
    content = courses?.slice(0, 4)?.map((course) => {
      ...
      return (
        <div key={_id} className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
              ...
              <div className="teacher__wrapper">
                ...
                <div className="teacher__bio">
                  ...
                  <p>
                    ...
                    boot up the kyver pardon you A bit of hows your father David
                    skive off sloshed, dont get shirty with me chip shop
                    vagabond crikey bugger Queens English chap. Matie boy nancy
                    ...
                    round dont get shirty with me down the pub well.
                  </p>
                </div>
                <div className="teacher__courses pt-55">
                  <div className="section__title-wrapper mb-30">
                    <h2 className="section__title">
                      Teacher{" "}
                      <span className="yellow-bg yellow-bg-big">Course</span>
                    </h2>
                  </div>
