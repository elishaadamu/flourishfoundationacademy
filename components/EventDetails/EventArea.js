      ...
      <section className="event__area pt-115 p-relative">
        <div className="page__title-shape">
          <img
            ...
            src="assets/img/breadcrumb/page-title-shape-1.png"
            alt=""
          />
          <img
            className="page-title-shape-6"
            src="assets/img/breadcrumb/page-title-shape-2.png"
            alt=""
          />
          <img
            className="page-title-shape-7"
            src="assets/img/breadcrumb/page-title-shape-4.png"
            alt=""
          />
          <img
            className="page-title-shape-8"
            src="assets/img/breadcrumb/page-title-shape-5.png"
            alt=""
          />
        </div>
            ...
            <div className="col-xxl-8">
              <div className="event__wrapper">
                <div className="page__title-content mb-25">
                  ...
                  <h5 className="breadcrumb__title-2">
